...
Download it: [[rtxdriver-0.01.tgz]]
...
== CONTENTS ==
;doc: Documentation
;misc: Miscellaneous dev tools and scripts, udev rules
;plugins: VOIP app plugins (only Ekiga for now)
;src: Source code for the phone driver
